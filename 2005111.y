...
%token<symbleInfo> IF ELSE LOWER_THAN_ELSE FOR WHILE DO BREAK CHAR DOUBLE RETURN BITOP LTHIRD RTHIRD SWITCH CASE DEFAULT CONTINUE PRINTLN INCOP DECOP ASSIGNOP NOT LPAREN RPAREN WHITESPACE LCURL RCURL COMMA SEMICOLON INT FLOAT VOID CONST_INT CONST_FLOAT ID ADDOP MULOP RELOP LOGICOP CONST_CHAR
...
| declaration_list COMMA ID LTHIRD CONST_INT RTHIRD {
  //  cout<<"hsfh";
    ...
    lexeme_details_out($5->gettype(), $5->getname());
    lexeme_details_out($6->gettype(), $6->getname());
    grammar_output("declaration_list","declaration_list COMMA ID LTHIRD CONST_INT RTHIRD");
    //$$ = new SymbleInfo("","declaration_list");
}
| ID {
//    cout<<"hjskdfjhks";
...
| ID LTHIRD CONST_INT RTHIRD {
 //   cout<<"ei";
    ...
    lexeme_details_out($3->gettype(), $3->getname());
    lexeme_details_out($4->gettype(), $4->getname());
    grammar_output("declaration_list","ID LTHIRD CONST_INT RTHIRD");
    //$$ = new SymbleInfo("","declaration_list");
}
;
...
| expression statement {
    grammar_output("statement","expression statement");
    //$$ = new SymbleInfo("","statement");
}
| compound_statement {
...
| FOR LPAREN expression statement expression statement expression RPAREN statement {
    ...
    grammar_output("statement","FOR LPAREN expression statement expression statement expression RPAREN statement");
    //$$ = new SymbleInfo("","statement");
}
...
| ID LTHIRD expression RTHIRD {
    ...
    lexeme_details_out($2->gettype(), $2->getname());
    lexeme_details_out($4->gettype(), $4->getname());
    grammar_output("variable","ID LTHIRD expression RTHIRD");
    //$$ = new SymbleInfo("","variable");
}
;
